...
All records are stored in a local database on your device only. There is no server, no cloud sync, and no backend of any kind operated by us. If you delete the app, your records are deleted with it, which is why the app includes a CSV export feature, so you always control your own backup.
