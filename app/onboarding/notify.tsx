 ...
 * art is a specimen of the real thing: one service, one date, over the app's
 * own icon, in the shape of the two lines the scheduler sends. It is an example,
 * not a render, and is shown whether or not this car has a dated record yet —
 * the point of the screen is to show what a reminder looks like, and a car
 * whose quiz answer was "Not sure" has nothing else to show for it.
 *
