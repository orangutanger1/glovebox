...
export const pl: Fragment = {
  ...
  "offer.paywall.preview.legend": "Najbliżej dla: {vehicle}",
  "offer.paywall.preview.locked": "Data i przypomnienie w Pro",
  "offer.paywall.preview.more": {
    one: "+{count} kolejny serwis, każdy z przypomnieniem",
    few: "+{count} kolejne serwisy, każdy z przypomnieniem",
    many: "+{count} kolejnych serwisów, każdy z przypomnieniem",
    other: "+{count} kolejnego serwisu, każdy z przypomnieniem",
  },
  "offer.badge.pro": "Pro",

  "offer.deal.title": "Oferta ograniczona czasowo",
  "offer.deal.pct": "{pct}% taniej",
  "offer.deal.perWeek": "Tylko {price} tygodniowo",
  ...
  "system.resume.first.title": "Twój plan jest prawie gotowy",
  "system.resume.first.title.named": "{name}, plan jest prawie gotowy",
  "system.resume.first.body": "{vehicle} · Jeszcze minuta i każdy termin przeglądu jest ustawiony.",
  "system.resume.second.title": "Wróć tam, gdzie przerwano",
  "system.resume.second.title.named": "{name}, wróć tam, gdzie przerwano",
  "system.resume.second.body": "{vehicle} · Wszystko, co wpisano, jest zapisane. Minuta i gotowe.",
  "system.resume.third.title": "Twój harmonogram czeka",
  "system.resume.third.title.named": "{name}, Twój harmonogram czeka",
  "system.resume.third.body": "{vehicle} · Dokończ konfigurację i zobacz, co i kiedy jest do zrobienia.",
  "system.resume.fourth.title": "Dwie minuty do pełnego planu",
  "system.resume.fourth.title.named": "{name}, dwie minuty do pełnego planu",
  "system.resume.fourth.body": "{vehicle} · Każdy interwał z datą i pod kontrolą. Dokończ dziś.",
  "system.resume.fifth.title": "Wciąż zapisane, wciąż gotowe",
  "system.resume.fifth.title.named": "{name}, wciąż zapisane i gotowe",
  "system.resume.fifth.body": "{vehicle} · Konfiguracja jest tam, gdzie ją zostawiono. Minuta do końca.",
  "system.resume.sixth.title": "Twoje auto zasługuje na plan",
  "system.resume.sixth.title.named": "{name}, auto zasługuje na plan",
  "system.resume.sixth.body": "{vehicle} · Większość kończy w niecałe dwie minuty. Ty jesteś w połowie.",
  "system.resume.seventh.title": "Konfiguracja wciąż tu jest",
  "system.resume.seventh.title.named": "{name}, konfiguracja wciąż tu jest",
  "system.resume.seventh.body": "{vehicle} · Kiedy zechcesz — minuta i gotowe.",
  "system.resume.ask.first.title": "Twój plan jest gotowy",
  "system.resume.ask.first.title.named": "{name}, Twój plan jest gotowy",
  "system.resume.ask.first.body": {
    one: "{vehicle} · 1 przegląd wymaga uwagi. Dalej zajmie się tym Pro.",
    few: "{vehicle} · {count} przeglądy wymagają uwagi. Pro zajmie się każdym.",
    many: "{vehicle} · {count} przeglądów wymaga uwagi. Pro zajmie się każdym.",
    other: "{vehicle} · {count} przeglądu wymaga uwagi. Pro zajmie się każdym.",
  },
  "system.resume.ask.first.body.zero": "{vehicle} · Każdy przegląd z datą i pod kontrolą. Dalej zajmie się tym Pro.",
  "system.resume.ask.second.title": "Jedno dotknięcie od spokoju",
  "system.resume.ask.second.title.named": "{name}, jedno dotknięcie od spokoju",
  "system.resume.ask.second.body": "{vehicle} · Plan jest gotowy i zapisany. Jedno dotknięcie i Pro go prowadzi.",
  "system.resume.ask.third.title": "Twój plan czeka",
  "system.resume.ask.third.title.named": "{name}, Twój plan czeka",
  "system.resume.ask.third.body": "{vehicle} · Nic nie trzeba wpisywać ponownie. Jedno dotknięcie i każdy przegląd pod kontrolą.",
  "system.resume.ask.fourth.title": "Z Pro nic nie umknie",
  "system.resume.ask.fourth.title.named": "{name}, z Pro nic nie umknie",
  "system.resume.ask.fourth.body": "{vehicle} · Plan jest zapisany. Większość znajduje zapomniany przegląd w pierwszym miesiącu.",
  "system.resume.ask.fifth.title": "Plan wciąż jest zapisany",
  "system.resume.ask.fifth.title.named": "{name}, plan wciąż jest zapisany",
  "system.resume.ask.fifth.body": "{vehicle} · Jedno dotknięcie i Pro przejmuje każdy termin przeglądu.",
  "system.resume.ask.sixth.title": "Licznik wciąż rośnie",
  "system.resume.ask.sixth.title.named": "{name}, licznik wciąż rośnie",
  "system.resume.ask.sixth.body": "{vehicle} · Plan jest gotowy nadążać. Jedno dotknięcie i masz spokój.",
  "system.resume.ask.seventh.title": "Miesiąc później, wciąż gotowy",
  "system.resume.ask.seventh.title.named": "{name}, wciąż gotowy",
  "system.resume.ask.seventh.body": "{vehicle} · Plan jest zapisany i czeka. Jedno dotknięcie i Pro przejmuje.",
  ...
  "subscribed.catchup.title": "Uzupełnij historię.",
  "subscribed.catchup.body": "Kiedy ostatnio wykonano każdą z tych czynności? Wystarczy przybliżona odpowiedź – „Brak wpisu” zamieni się w prawdziwy termin.",
  "subscribed.catchup.overYear": "Ponad rok temu",
  "subscribed.catchup.save": "Zapisz historię",
  "subscribed.catchup.skip": "Nie teraz",
  "fuel.title": "Paliwo",
  ...
  // survey
  "survey.source.title": "Skąd się o nas dowiedziałeś?",
  "survey.source.tiktok": "TikTok",
  "survey.source.instagram": "Instagram",
  "survey.source.youtube": "YouTube",
  "survey.source.app_store": "Wyszukiwanie w App Store",
  "survey.source.friend": "Od znajomego lub rodziny",
  "survey.source.other": "Skądś indziej",
  "survey.objection.title": "Co cię powstrzymało?",
  "survey.objection.subtitle": "Jedno dotknięcie. Pokaże nam, co poprawić.",
  "survey.objection.price": "Za drogo",
  "survey.objection.try_first": "Chcę najpierw wypróbować",
  "survey.objection.browsing": "Tylko się rozglądam",
  "survey.objection.no_car": "Nie mam samochodu",
  "survey.objection.other": "Coś innego",
  "survey.objection.skip": "Pomiń",

  // Odometer check-in and the glovebox.
  "checkin.title": "Stan licznika",
  "checkin.notify.title": "Czas sprawdzić stan licznika",
  "checkin.notify.title.named": "{name}, czas sprawdzić stan licznika",
  "checkin.notify.body": "{vehicle} · Ile pokazuje licznik? Jedna liczba utrzymuje przypomnienia na czas.",
  "checkin.last": "Ostatni odczyt, {date}",
  "checkin.field": "Stan licznika dziś ({unit})",
  "checkin.why": "Serwisy zależne od przebiegu, jak wymiana oleju, liczone są z tej liczby.",
  "checkin.save": "Zapisz odczyt",
  "checkin.same": "Bez zmian",
  "checkin.lower": "To mniej niż ostatni odczyt ({reading} {unit}). Jeśli tamten był błędny, dotknij nazwy auta, aby go poprawić.",
  "checkin.gone": "Tego auta nie ma już w garażu.",
  "checkin.update": "Zaktualizuj przebieg",
  "documents.legend": "Schowek",
  "documents.add": "Dodaj dokument",
  "documents.empty": "Ubezpieczenie, dowód rejestracyjny i inne, z przypomnieniem przed wygaśnięciem.",
  "documents.kind.insurance": "Ubezpieczenie",
  "documents.kind.registration": "Dowód rejestracyjny",
  "documents.kind.inspection": "Przegląd techniczny",
  "documents.kind.license": "Prawo jazdy",
  "documents.kind.warranty": "Gwarancja",
  "documents.kind.roadside": "Pomoc drogowa",
  "documents.kind.other": "Inne",
  "documents.row.expires": "Ważne do {date}",
  "documents.row.expired": "Wygasło {date}",
  "documents.row.noExpiry": "Bezterminowo",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Wygasło",
  "documents.badge.soon": "Wkrótce wygasa",
  "documents.form.title": "Dodaj dokument",
  "documents.form.editTitle": "Edytuj dokument",
  "documents.form.kind": "Co to jest?",
  "documents.form.issuer": "Wystawca",
  "documents.form.name": "Nazwa",
  "documents.form.number": "Numer polisy lub dokumentu",
  "documents.form.expiry": "Ważność",
  "documents.form.expires": "Wygasa",
  "documents.form.noExpiry": "Nie wygasa",
  "documents.form.remind": "Przypomnimy 30 i 7 dni wcześniej.",
  "documents.form.notes": "Notatki",
  "documents.form.save": "Zapisz",
  "documents.form.error": "Nie udało się zapisać. Spróbuj ponownie.",
  "documents.form.private": "Zapisane tylko na tym telefonie.",
  "documents.delete.button": "Usuń dokument",
  "documents.delete.title": "Usunąć ten dokument?",
  "documents.delete.body": "Zniknie ze schowka i przestanie wysyłać przypomnienia.",
  "documents.delete.cancel": "Anuluj",
  "documents.delete.confirm": "Usuń",
  "documents.notify.title": "{document} wygasa {date}",
  "documents.notify.body": "{vehicle} · Odnów przed wygaśnięciem.",
  "system.csv.doc.kind": "Dokument",
  "system.csv.doc.issuer": "Wystawca",
  "system.csv.doc.number": "Numer",
  "system.csv.doc.expires": "Ważne do",
};
