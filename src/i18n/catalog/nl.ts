...
export const nl: Fragment = {
  ...
  "vehicle.recalls.legend": "Terugroepacties",
  "vehicle.recalls.found": {"one": "{count} terugroepactie voor de {vehicle}", "other": "{count} terugroepacties voor de {vehicle}"},
  "vehicle.recalls.none": "Geen terugroepacties op de NHTSA-lijst voor de {vehicle}.",
  "vehicle.recalls.parkIt": "Rijd er niet mee tot het is verholpen",
  "vehicle.recalls.risk": "Het risico",
  "vehicle.recalls.remedy": "De oplossing",
  "vehicle.recalls.details": "Meer",
  "vehicle.recalls.hide": "Verbergen",
  "vehicle.recalls.check": "Controleer je VIN op nhtsa.gov",
  "vehicle.recalls.note": "Uit de openbare terugroeplijst van de NHTSA, per modeljaar — niet voor het VIN van je auto. Alleen merk, model en bouwjaar verlaten deze telefoon.",
  ...
  "subscribed.catchup.title": "Vul de gaten in.",
  "subscribed.catchup.body": "Wanneer is elk hiervan voor het laatst gedaan? Een schatting is genoeg: „Geen gegevens” wordt een echte datum.",
  "subscribed.catchup.overYear": "Meer dan een jaar geleden",
  "subscribed.catchup.save": "Geschiedenis opslaan",
  "subscribed.catchup.skip": "Later",
  ...
  // survey
  "survey.source.title": "Hoe heb je over ons gehoord?",
  "survey.source.tiktok": "TikTok",
  "survey.source.instagram": "Instagram",
  "survey.source.youtube": "YouTube",
  "survey.source.app_store": "Zoeken in de App Store",
  "survey.source.friend": "Een vriend of familielid",
  "survey.source.other": "Ergens anders",
  "survey.objection.title": "Wat hield je tegen?",
  "survey.objection.subtitle": "Eén tik. Zo weten we wat we moeten verbeteren.",
  "survey.objection.price": "Het is te duur",
  "survey.objection.try_first": "Ik wil het eerst proberen",
  "survey.objection.browsing": "Ik kijk alleen even rond",
  "survey.objection.no_car": "Ik heb geen auto",
  "survey.objection.other": "Iets anders",
  "survey.objection.skip": "Overslaan",

  // Odometer check-in and the glovebox.
  "checkin.title": "Kilometerstand-check",
  "checkin.notify.title": "Tijd voor je kilometerstand",
  "checkin.notify.title.named": "{name}, tijd voor je kilometerstand",
  "checkin.notify.body": "{vehicle} · Wat staat er op de teller? Eén getal houdt je herinneringen op tijd.",
  "checkin.last": "Laatste stand, {date}",
  "checkin.field": "Kilometerstand vandaag ({unit})",
  "checkin.why": "Onderhoud op afstand, zoals olie verversen, wordt uit dit getal berekend.",
  "checkin.save": "Stand opslaan",
  "checkin.same": "Niet veranderd",
  "checkin.lower": "Dat is lager dan de laatste stand ({reading} {unit}). Klopte die niet, tik dan op de naam van de auto om hem te corrigeren.",
  "checkin.gone": "Deze auto staat niet meer in je garage.",
  "checkin.update": "Kilometerstand bijwerken",
  "documents.legend": "Handschoenenkastje",
  "documents.add": "Document toevoegen",
  "documents.empty": "Verzekering, kentekenbewijs en meer, met een herinnering voordat ze verlopen.",
  "documents.kind.insurance": "Verzekering",
  "documents.kind.registration": "Kentekenbewijs",
  "documents.kind.inspection": "APK-rapport",
  "documents.kind.license": "Rijbewijs",
  "documents.kind.warranty": "Garantiebewijs",
  "documents.kind.roadside": "Pechhulp",
  "documents.kind.other": "Overig",
  "documents.row.expires": "Verloopt op {date}",
  "documents.row.expired": "Verlopen op {date}",
  "documents.row.noExpiry": "Verloopt niet",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Verlopen",
  "documents.badge.soon": "Verloopt binnenkort",
  "documents.form.title": "Document toevoegen",
  "documents.form.editTitle": "Document bewerken",
  "documents.form.kind": "Wat is het?",
  "documents.form.issuer": "Uitgegeven door",
  "documents.form.name": "Naam",
  "documents.form.number": "Polis- of documentnummer",
  "documents.form.expiry": "Vervaldatum",
  "documents.form.expires": "Verloopt",
  "documents.form.noExpiry": "Verloopt niet",
  "documents.form.remind": "Je krijgt 30 en 7 dagen van tevoren een herinnering.",
  "documents.form.notes": "Notities",
  "documents.form.save": "Opslaan",
  "documents.form.error": "Opslaan lukte niet. Probeer het opnieuw.",
  "documents.form.private": "Alleen op deze telefoon opgeslagen.",
  "documents.delete.button": "Document verwijderen",
  "documents.delete.title": "Dit document verwijderen?",
  "documents.delete.body": "Het verdwijnt uit het handschoenenkastje en stuurt geen herinneringen meer.",
  "documents.delete.cancel": "Annuleren",
  "documents.delete.confirm": "Verwijderen",
  "documents.notify.title": "{document} verloopt op {date}",
  "documents.notify.body": "{vehicle} · Verleng het op tijd.",
  "system.csv.doc.kind": "Document",
  "system.csv.doc.issuer": "Uitgegeven door",
  "system.csv.doc.number": "Nummer",
  "system.csv.doc.expires": "Verloopt",
};
