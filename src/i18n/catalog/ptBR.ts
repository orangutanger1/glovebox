...
export const ptBR: Fragment = {
  ...
  "system.resume.first.title": "Seu plano está quase pronto",
  "system.resume.first.title.named": "{name}, seu plano está quase pronto",
  "system.resume.first.body": "{vehicle} · Mais um minuto e cada data de serviço fica definida.",
  "system.resume.second.title": "Continue de onde parou",
  "system.resume.second.title.named": "{name}, continue de onde parou",
  "system.resume.second.body": "{vehicle} · Tudo o que você digitou está salvo. Um minuto e termina.",
  "system.resume.third.title": "Seu cronograma está esperando",
  "system.resume.third.title.named": "{name}, seu cronograma espera",
  "system.resume.third.body": "{vehicle} · Termine a configuração e veja o que vence, e quando.",
  "system.resume.fourth.title": "Dois minutos para um plano completo",
  "system.resume.fourth.title.named": "{name}, dois minutos para o plano",
  "system.resume.fourth.body": "{vehicle} · Cada intervalo com data e acompanhamento. Termine hoje.",
  "system.resume.fifth.title": "Ainda salvo, ainda pronto",
  "system.resume.fifth.title.named": "{name}, ainda salvo, ainda pronto",
  "system.resume.fifth.body": "{vehicle} · Sua configuração está onde você deixou. Um minuto e pronto.",
  "system.resume.sixth.title": "Seu carro merece um plano",
  "system.resume.sixth.title.named": "{name}, seu carro merece um plano",
  "system.resume.sixth.body": "{vehicle} · A maioria termina em menos de dois minutos. O seu já está na metade.",
  "system.resume.seventh.title": "Sua configuração ainda está aqui",
  "system.resume.seventh.title.named": "{name}, ainda está tudo aqui",
  "system.resume.seventh.body": "{vehicle} · Quando quiser, um minuto e termina.",
  "system.resume.ask.first.title": "Seu plano está pronto",
  "system.resume.ask.first.title.named": "{name}, seu plano está pronto",
  "system.resume.ask.first.body": {
    one: "{vehicle} · 1 serviço precisa de atenção. O Pro cuida daqui em diante.",
    other: "{vehicle} · {count} serviços precisam de atenção. O Pro cuida de todos.",
  },
  "system.resume.ask.first.body.zero": "{vehicle} · Cada serviço com data e acompanhamento. O Pro cuida daqui em diante.",
  "system.resume.ask.second.title": "A um toque de estar coberto",
  "system.resume.ask.second.title.named": "{name}, a um toque de estar coberto",
  "system.resume.ask.second.body": "{vehicle} · Seu plano está pronto e salvo. Um toque e o Pro assume.",
  "system.resume.ask.third.title": "Seu plano está esperando",
  "system.resume.ask.third.title.named": "{name}, seu plano está esperando",
  "system.resume.ask.third.body": "{vehicle} · Nada para digitar de novo. Um toque e cada serviço é acompanhado.",
  "system.resume.ask.fourth.title": "Com o Pro nada escapa",
  "system.resume.ask.fourth.title.named": "{name}, com o Pro nada escapa",
  "system.resume.ask.fourth.body": "{vehicle} · Seu plano está salvo. A maioria descobre um serviço esquecido no primeiro mês.",
  "system.resume.ask.fifth.title": "Seu plano continua salvo",
  "system.resume.ask.fifth.title.named": "{name}, seu plano continua salvo",
  "system.resume.ask.fifth.body": "{vehicle} · Um toque e o Pro assume cada data de serviço daqui em diante.",
  "system.resume.ask.sixth.title": "O hodômetro continua subindo",
  "system.resume.ask.sixth.title.named": "{name}, o hodômetro continua subindo",
  "system.resume.ask.sixth.body": "{vehicle} · Seu plano está pronto para acompanhar. Um toque e você está coberto.",
  "system.resume.ask.seventh.title": "Um mês depois, ainda pronto",
  "system.resume.ask.seventh.title.named": "{name}, um mês depois, ainda pronto",
  "system.resume.ask.seventh.body": "{vehicle} · Seu plano está salvo e esperando. Um toque e o Pro assume.",
  ...
  "subscribed.catchup.title": "Preencha o histórico.",
  "subscribed.catchup.body": "Quando cada um foi feito pela última vez? Uma estimativa basta: “Sem registro” vira uma data real.",
  "subscribed.catchup.overYear": "Há mais de um ano",
  "subscribed.catchup.save": "Salvar histórico",
  "subscribed.catchup.skip": "Agora não",
  ...
  // survey
  "survey.source.title": "Como você conheceu o app?",
  "survey.source.tiktok": "TikTok",
  "survey.source.instagram": "Instagram",
  "survey.source.youtube": "YouTube",
  "survey.source.app_store": "Buscando na App Store",
  "survey.source.friend": "Um amigo ou familiar",
  "survey.source.other": "Outro lugar",
  "survey.objection.title": "O que te impediu?",
  "survey.objection.subtitle": "Um toque. Mostra o que devemos melhorar.",
  "survey.objection.price": "É caro demais",
  "survey.objection.try_first": "Quero testar primeiro",
  "survey.objection.browsing": "Só estou olhando",
  "survey.objection.no_car": "Não tenho carro",
  "survey.objection.other": "Outra coisa",
  "survey.objection.skip": "Pular",
};
