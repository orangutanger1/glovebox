...
export const ptBR: Fragment = {
  ...
  "offer.paywall.preview.more": {
    one: "+{count} serviço, cada um com lembrete",
    other: "+{count} serviços, cada um com lembrete",
  },
  "offer.badge.pro": "Pro",
  ...
  "checkin.title": "Conferir o hodômetro",
  "checkin.notify.title": "Hora de conferir o hodômetro",
  "checkin.notify.title.named": "{name}, hora de conferir o hodômetro",
  "checkin.notify.body": "{vehicle} · Quanto marca o hodômetro? Um número mantém seus lembretes em dia.",
  "checkin.last": "Última leitura, {date}",
  "checkin.field": "Hodômetro hoje ({unit})",
  "checkin.why": "Serviços por quilometragem, como a troca de óleo, são calculados a partir deste número.",
  "checkin.save": "Salvar leitura",
  "checkin.same": "Não mudou",
  "checkin.lower": "É menos que a última leitura ({reading} {unit}). Se ela estava errada, toque no nome do carro para corrigir.",
  "checkin.gone": "Este carro não está mais na sua garagem.",
  "checkin.update": "Atualizar quilometragem",
  "documents.legend": "Porta-luvas",
  "documents.add": "Adicionar documento",
  "documents.empty": "Seguro, CRLV e mais, com um lembrete antes de vencer.",
  "documents.kind.insurance": "Seguro",
  "documents.kind.registration": "CRLV",
  "documents.kind.inspection": "Laudo de vistoria",
  "documents.kind.license": "CNH",
  "documents.kind.warranty": "Garantia",
  "documents.kind.roadside": "Assistência 24h",
  "documents.kind.other": "Outro",
  "documents.row.expires": "Vence em {date}",
  "documents.row.expired": "Venceu em {date}",
  "documents.row.noExpiry": "Sem vencimento",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Vencido",
  "documents.badge.soon": "Vence em breve",
  "documents.form.title": "Adicionar documento",
  "documents.form.editTitle": "Editar documento",
  "documents.form.kind": "O que é?",
  "documents.form.issuer": "Emitido por",
  "documents.form.name": "Nome",
  "documents.form.number": "Número da apólice ou documento",
  "documents.form.expiry": "Vencimento",
  "documents.form.expires": "Vence",
  "documents.form.noExpiry": "Não vence",
  "documents.form.remind": "Você recebe um lembrete 30 e 7 dias antes.",
  "documents.form.notes": "Observações",
  "documents.form.save": "Salvar",
  "documents.form.error": "Não foi possível salvar. Tente de novo.",
  "documents.form.private": "Salvo só neste celular.",
  "documents.delete.button": "Excluir documento",
  "documents.delete.title": "Excluir este documento?",
  "documents.delete.body": "Ele sai do porta-luvas e para de enviar lembretes.",
  "documents.delete.cancel": "Cancelar",
  "documents.delete.confirm": "Excluir",
  "documents.notify.title": "{document} vence em {date}",
  "documents.notify.body": "{vehicle} · Renove antes do vencimento.",
  "system.csv.doc.kind": "Documento",
  "system.csv.doc.issuer": "Emitido por",
  "system.csv.doc.number": "Número",
  "system.csv.doc.expires": "Vencimento",
};
