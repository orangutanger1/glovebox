...
export const sv: Fragment = {
  ...
  "vehicle.recalls.legend": "Återkallelser",
  "vehicle.recalls.found": {"one": "{count} återkallelse gäller {vehicle}", "other": "{count} återkallelser gäller {vehicle}"},
  "vehicle.recalls.none": "Inga återkallelser på NHTSA:s lista för {vehicle}.",
  "vehicle.recalls.parkIt": "Kör inte förrän det är åtgärdat",
  "vehicle.recalls.risk": "Risken",
  "vehicle.recalls.remedy": "Åtgärden",
  "vehicle.recalls.details": "Detaljer",
  "vehicle.recalls.hide": "Dölj",
  "vehicle.recalls.check": "Kolla ditt VIN på nhtsa.gov",
  "vehicle.recalls.note": "Från NHTSA:s offentliga lista, för årsmodellen — inte för din bils VIN. Bara märke, modell och årsmodell lämnar telefonen.",
  ...
  "subscribed.catchup.title": "Fyll i luckorna.",
  "subscribed.catchup.body": "När gjordes vart och ett senast? Ett ungefärligt svar räcker – ”Inga uppgifter” blir ett riktigt datum.",
  "subscribed.catchup.overYear": "För över ett år sedan",
  "subscribed.catchup.save": "Spara historik",
  "subscribed.catchup.skip": "Inte nu",
  "fuel.title": "Bränsle",
  ...
  "checkin.title": "Mätarkoll",
  "checkin.notify.title": "Dags att kolla mätarställningen",
  "checkin.notify.title.named": "{name}, dags att kolla mätarställningen",
  "checkin.notify.body": "{vehicle} · Vad visar mätaren? En siffra håller dina påminnelser i tid.",
  "checkin.last": "Senaste avläsning, {date}",
  "checkin.field": "Mätarställning i dag ({unit})",
  "checkin.why": "Service efter körsträcka, som oljebyte, räknas ut från den här siffran.",
  "checkin.save": "Spara avläsning",
  "checkin.same": "Oförändrad",
  "checkin.lower": "Det är lägre än senaste avläsningen ({reading} {unit}). Om den var fel, tryck på bilens namn för att rätta den.",
  "checkin.gone": "Den här bilen finns inte längre i ditt garage.",
  "checkin.update": "Uppdatera mätarställning",
  "documents.legend": "Handskfack",
  "documents.add": "Lägg till dokument",
  "documents.empty": "Försäkring, registreringsbevis och mer, med en påminnelse innan de går ut.",
  "documents.kind.insurance": "Försäkring",
  "documents.kind.registration": "Registreringsbevis",
  "documents.kind.inspection": "Besiktningsprotokoll",
  "documents.kind.license": "Körkort",
  "documents.kind.warranty": "Garanti",
  "documents.kind.roadside": "Vägassistans",
  "documents.kind.other": "Övrigt",
  "documents.row.expires": "Går ut {date}",
  "documents.row.expired": "Gick ut {date}",
  "documents.row.noExpiry": "Går inte ut",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Utgången",
  "documents.badge.soon": "Går snart ut",
  "documents.form.title": "Lägg till dokument",
  "documents.form.editTitle": "Redigera dokument",
  "documents.form.kind": "Vad är det?",
  "documents.form.issuer": "Utfärdat av",
  "documents.form.name": "Namn",
  "documents.form.number": "Försäkrings- eller dokumentnummer",
  "documents.form.expiry": "Giltighet",
  "documents.form.expires": "Går ut",
  "documents.form.noExpiry": "Går inte ut",
  "documents.form.remind": "Du får en påminnelse 30 och 7 dagar innan.",
  "documents.form.notes": "Anteckningar",
  "documents.form.save": "Spara",
  "documents.form.error": "Det gick inte att spara. Försök igen.",
  "documents.form.private": "Sparas bara på den här telefonen.",
  "documents.delete.button": "Ta bort dokument",
  "documents.delete.title": "Ta bort det här dokumentet?",
  "documents.delete.body": "Det försvinner ur handskfacket och slutar skicka påminnelser.",
  "documents.delete.cancel": "Avbryt",
  "documents.delete.confirm": "Ta bort",
  "documents.notify.title": "{document} går ut {date}",
  "documents.notify.body": "{vehicle} · Förnya i tid.",
  "system.csv.doc.kind": "Dokument",
  "system.csv.doc.issuer": "Utfärdat av",
  "system.csv.doc.number": "Nummer",
  "system.csv.doc.expires": "Går ut",
};
