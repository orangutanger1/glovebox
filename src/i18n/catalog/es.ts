...
export const es: Fragment = {
  ...
  "evidence.records.answer": "SQLite en tu móvil, y todo el historial sale en CSV.",

  "evidence.price.label": "el precio, el muro de pago o lo que acabó costando",
  "evidence.price.answer":
    "Una suscripción y nada más que comprar. Todos los coches, todos los registros.",
  ...
  "evidence.crashes.answer":
    "Tus registros viven en una base de datos del móvil, no en un archivo que puede no abrirse.",
  ...
  "features.export.subtitle":
    "Sácate todo el historial en una hoja de cálculo cuando quieras.",
  ...
  "offer.deal.perWeek": "Solo {price} a la semana",
  ...
  "offer.winback.caption": "O inténtalo una vez más: un año de Pro al precio de oferta. Cancela cuando quieras.",
  ...
  "onboardingA.odometer.required": "Introduce la lectura para continuar.",
  ...
  "pain.records.fix":
    "Un historial con fechas, y una hoja de cálculo cuando la necesites.",
  ...
  "system.resume.first.title": "Tu plan está casi listo",
  "system.resume.first.title.named": "{name}, tu plan está casi listo",
  "system.resume.first.body": "{vehicle} · Un minuto más y cada fecha de servicio queda fijada.",
  "system.resume.second.title": "Sigue donde lo dejaste",
  "system.resume.second.title.named": "{name}, sigue donde lo dejaste",
  "system.resume.second.body": "{vehicle} · Todo lo que pusiste está guardado. Un minuto y listo.",
  "system.resume.third.title": "Tu calendario te espera",
  "system.resume.third.title.named": "{name}, tu calendario te espera",
  "system.resume.third.body": "{vehicle} · Termina la configuración y ve qué toca y cuándo.",
  "system.resume.fourth.title": "Dos minutos para tu plan",
  "system.resume.fourth.title.named": "{name}, dos minutos para tu plan",
  "system.resume.fourth.body": "{vehicle} · Cada intervalo con fecha y seguimiento. Termina hoy.",
  "system.resume.fifth.title": "Guardado y listo",
  "system.resume.fifth.title.named": "{name}, guardado y listo",
  "system.resume.fifth.body": "{vehicle} · Tu configuración sigue donde la dejaste. Un minuto y termina.",
  "system.resume.sixth.title": "Tu coche merece un plan",
  "system.resume.sixth.title.named": "{name}, tu coche merece un plan",
  "system.resume.sixth.body": "{vehicle} · La mayoría termina en menos de dos minutos. El tuyo va por la mitad.",
  "system.resume.seventh.title": "Tu configuración sigue aquí",
  "system.resume.seventh.title.named": "{name}, tu configuración sigue aquí",
  "system.resume.seventh.body": "{vehicle} · Cuando quieras, un minuto y queda lista.",
  "system.resume.ask.first.title": "Tu plan está listo",
  "system.resume.ask.first.title.named": "{name}, tu plan está listo",
  "system.resume.ask.first.body": {
    one: "{vehicle} · 1 servicio necesita atención. Pro se encarga desde aquí.",
    other: "{vehicle} · {count} servicios necesitan atención. Pro se encarga de todos.",
  },
  "system.resume.ask.first.body.zero": "{vehicle} · Cada servicio con fecha y seguimiento. Pro se encarga desde aquí.",
  "system.resume.ask.second.title": "A un toque de estar cubierto",
  "system.resume.ask.second.title.named": "{name}, a un toque de cubrirlo",
  "system.resume.ask.second.body": "{vehicle} · Tu plan está hecho y guardado. Un toque y Pro lo lleva.",
  "system.resume.ask.third.title": "Tu plan te espera",
  "system.resume.ask.third.title.named": "{name}, tu plan te espera",
  "system.resume.ask.third.body": "{vehicle} · Nada que volver a escribir. Un toque y cada servicio queda vigilado.",
  "system.resume.ask.fourth.title": "Con Pro nada se escapa",
  "system.resume.ask.fourth.title.named": "{name}, con Pro nada se escapa",
  "system.resume.ask.fourth.body": "{vehicle} · Tu plan está guardado. La mayoría detecta un servicio olvidado el primer mes.",
  "system.resume.ask.fifth.title": "Tu plan sigue guardado",
  "system.resume.ask.fifth.title.named": "{name}, tu plan sigue guardado",
  "system.resume.ask.fifth.body": "{vehicle} · Un toque y Pro retoma cada fecha de servicio desde aquí.",
  "system.resume.ask.sixth.title": "El cuentakilómetros no para",
  "system.resume.ask.sixth.title.named": "{name}, el cuentakilómetros no para",
  "system.resume.ask.sixth.body": "{vehicle} · Tu plan está listo para seguirle el ritmo. Un toque y estás cubierto.",
  "system.resume.ask.seventh.title": "Un mes después, sigue listo",
  "system.resume.ask.seventh.title.named": "{name}, un mes después, sigue listo",
  "system.resume.ask.seventh.body": "{vehicle} · Tu plan está guardado y te espera. Un toque y Pro se encarga.",
  ...
  "system.quickaction.trial.title": "Prueba Pro",
  "system.quickaction.trial.subtitle": "Un año de Pro al precio de oferta",
  ...
  "subscribed.unlocked": "Ahora activo",
  "subscribed.cta": "Ver el plan",
  "subscribed.catchup.title": "Completa lo que falta.",
  "subscribed.catchup.body": "¿Cuándo se hizo cada uno por última vez? Basta con una idea aproximada: convierte «Sin registro» en una fecha real.",
  "subscribed.catchup.overYear": "Hace más de un año",
  "subscribed.catchup.save": "Guardar historial",
  "subscribed.catchup.skip": "Ahora no",
  "fuel.title": "Combustible",
  "fuel.log": "Registrar repostaje",
  "fuel.seeAll": "Ver todos los repostajes",
  "fuel.summary.last": "Último depósito",
  "fuel.summary.average": "Media",
  "fuel.summary.needFirst": "Registra un repostaje y aparecerá aquí.",
  "fuel.summary.needSecond": "Un depósito lleno más y llega tu primer dato.",
  "fuel.history.title": "Repostajes",
  "fuel.history.empty": "Aún no hay repostajes registrados.",
  "fuel.row.partial": "Repostaje parcial",
  "fuel.deleted": "Repostaje eliminado",
  "fuel.undo": "Deshacer",
  "fuel.swipe.delete": "Eliminar",
  "fuel.form.title": "Registrar repostaje",
  "fuel.form.odometer": "Cuentakilómetros ({unit})",
  "fuel.form.volume": "Combustible ({unit})",
  "fuel.form.cost": "Total pagado (opcional)",
  "fuel.form.full": "Depósito lleno",
  "fuel.form.fullHint": "Déjalo activado salvo que no hayas llenado del todo.",
  "fuel.form.when": "Cuándo",
  "fuel.form.today": "Hoy",
  "fuel.form.yesterday": "Ayer",
  "fuel.form.otherDate": "Otro día",
  ...
  "fuel.card.fills": { one: "De {count} repostaje con precio.", other: "De {count} repostajes con precio." },
  "fuel.card.unpriced": { one: "Otro {count} repostaje no tiene coste registrado.", other: "Otros {count} repostajes no tienen coste registrado." },
  "fuel.card.locked.title": "Descubre lo que te cuesta el combustible",
  "fuel.card.locked.body": "Tus repostajes ya están registrados. Pro los convierte en consumo, gasto y coste por distancia.",
  "fuel.card.locked.cta": "Desbloquear análisis de combustible",
  "fuel.card.empty": "Registra dos depósitos llenos y esto se completará.",
  "unit.gal": "{value} gal",
  "unit.litre": "{value} L",
  "unit.gal.label": "gal",
  "unit.litre.label": "L",
  ...
  "system.csv.fuel.volume": "Combustible ({unit})",
  "system.csv.fuel.full": "Depósito lleno",
  "system.csv.cell.yes": "Sí",
  ...
  // survey
  "survey.source.title": "¿Cómo nos conociste?",
  "survey.source.tiktok": "TikTok",
  "survey.source.instagram": "Instagram",
  "survey.source.youtube": "YouTube",
  "survey.source.app_store": "Buscando en el App Store",
  "survey.source.friend": "Un amigo o familiar",
  "survey.source.other": "En otro sitio",
  "survey.objection.title": "¿Qué te frenó?",
  "survey.objection.subtitle": "Un toque. Nos dice qué mejorar.",
  "survey.objection.price": "Es demasiado caro",
  "survey.objection.try_first": "Quiero probarla primero",
  "survey.objection.browsing": "Solo estoy mirando",
  "survey.objection.no_car": "No tengo coche",
  "survey.objection.other": "Otra cosa",
  "survey.objection.skip": "Omitir",

  // Odometer check-in and the glovebox.
  "checkin.title": "Revisión del cuentakilómetros",
  "checkin.notify.title": "Hora de revisar el cuentakilómetros",
  "checkin.notify.title.named": "{name}, hora de revisar el cuentakilómetros",
  "checkin.notify.body": "{vehicle} · ¿Qué marca el cuentakilómetros? Un número mantiene tus recordatorios a tiempo.",
  "checkin.last": "Última lectura, {date}",
  "checkin.field": "Cuentakilómetros hoy ({unit})",
  "checkin.why": "Los mantenimientos por distancia, como el cambio de aceite, se calculan con este número.",
  "checkin.save": "Guardar lectura",
  "checkin.same": "No ha cambiado",
  "checkin.lower": "Es menos que la última lectura ({reading} {unit}). Si esa estaba mal, toca el nombre del coche para corregirla.",
  "checkin.gone": "Este coche ya no está en tu garaje.",
  "checkin.update": "Actualizar kilometraje",
  "documents.legend": "Guantera",
  "documents.add": "Añadir un documento",
  "documents.empty": "Seguro, permiso de circulación y más, con un aviso antes de que caduquen.",
  "documents.kind.insurance": "Seguro",
  "documents.kind.registration": "Permiso de circulación",
  "documents.kind.inspection": "Informe de la ITV",
  "documents.kind.license": "Carné de conducir",
  "documents.kind.warranty": "Garantía",
  "documents.kind.roadside": "Asistencia en carretera",
  "documents.kind.other": "Otro",
  "documents.row.expires": "Caduca el {date}",
  "documents.row.expired": "Caducó el {date}",
  "documents.row.noExpiry": "Sin caducidad",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Caducado",
  "documents.badge.soon": "Caduca pronto",
  "documents.form.title": "Añadir documento",
  "documents.form.editTitle": "Editar documento",
  "documents.form.kind": "¿Qué es?",
  "documents.form.issuer": "Emitido por",
  "documents.form.name": "Nombre",
  "documents.form.number": "Número de póliza o documento",
  "documents.form.expiry": "Caducidad",
  "documents.form.expires": "Caduca",
  "documents.form.noExpiry": "No caduca",
  "documents.form.remind": "Te avisaremos 30 y 7 días antes.",
  "documents.form.notes": "Notas",
  "documents.form.save": "Guardar",
  "documents.form.error": "No se pudo guardar. Inténtalo de nuevo.",
  "documents.form.private": "Guardado solo en este teléfono.",
  "documents.delete.button": "Eliminar documento",
  "documents.delete.title": "¿Eliminar este documento?",
  "documents.delete.body": "Desaparecerá de la guantera y dejará de enviar recordatorios.",
  "documents.delete.cancel": "Cancelar",
  "documents.delete.confirm": "Eliminar",
  "documents.notify.title": "{document} caduca el {date}",
  "documents.notify.body": "{vehicle} · Renuévalo antes de que caduque.",
  "system.csv.doc.kind": "Documento",
  "system.csv.doc.issuer": "Emitido por",
  "system.csv.doc.number": "Número",
  "system.csv.doc.expires": "Caduca",
};
