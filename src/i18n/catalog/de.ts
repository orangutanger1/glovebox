...
export const de: Fragment = {
  ...
  "offer.deal.perWeek": "Nur {price} pro Woche",
  ...
  "onboardingC.cost.oilChanges": "Ölwechsel überfällig",
  "onboardingC.cost.tracked": "Wrenchy behält im Blick, welche Services dein Auto braucht.",
  "onboardingC.cost.source": "{overdue}. US-Werte.",
  "onboardingC.cost.continue": "Weiter",

  "onboardingC.compare.title": "Auf eigene Faust oder nach Plan.",
  "onboardingC.compare.subtitle": "Dein {vehicle}, auf beide Arten gepflegt.",
  "onboardingC.compare.dated": "Services mit einem Datum",
  "onboardingC.compare.remembered": "Services, die du im Kopf behalten musst",
  "onboardingC.compare.alone": "Auf eigene Faust",
  "onboardingC.compare.withApp": "Mit Wrenchy",
  "onboardingC.compare.ofTotal": "{count} von {total}",
  "onboardingC.compare.source": "Aus deinen eigenen Angaben gezählt. Keine Durchschnittswerte, keine Schätzungen.",
  "onboardingC.compare.continue": "Weiter",
  ...
  "system.resume.first.title": "Ihr Plan ist fast fertig",
  "system.resume.first.title.named": "{name}, Ihr Plan ist fast fertig",
  "system.resume.first.body": "{vehicle} · Noch eine Minute, dann steht jeder Wartungstermin.",
  "system.resume.second.title": "Machen Sie einfach weiter",
  "system.resume.second.title.named": "{name}, machen Sie einfach weiter",
  "system.resume.second.body": "{vehicle} · Alle Eingaben sind gespeichert. Eine Minute, dann ist es fertig.",
  "system.resume.third.title": "Ihr Wartungsplan wartet",
  "system.resume.third.title.named": "{name}, Ihr Wartungsplan wartet",
  "system.resume.third.body": "{vehicle} · Einrichtung abschließen und sehen, was wann fällig ist.",
  "system.resume.fourth.title": "Zwei Minuten bis zum Plan",
  "system.resume.fourth.title.named": "{name}, zwei Minuten bis zum Plan",
  "system.resume.fourth.body": "{vehicle} · Jedes Intervall datiert und im Blick. Heute abschließen.",
  "system.resume.fifth.title": "Gespeichert und bereit",
  "system.resume.fifth.title.named": "{name}, gespeichert und bereit",
  "system.resume.fifth.body": "{vehicle} · Ihre Einrichtung liegt, wo Sie aufgehört haben. Eine Minute noch.",
  "system.resume.sixth.title": "Ihr Auto verdient einen Plan",
  "system.resume.sixth.title.named": "{name}, Ihr Auto verdient einen Plan",
  "system.resume.sixth.body": "{vehicle} · Die meisten sind in unter zwei Minuten fertig. Sie sind schon halb durch.",
  "system.resume.seventh.title": "Ihre Einrichtung ist noch da",
  "system.resume.seventh.title.named": "{name}, Ihre Einrichtung ist noch da",
  "system.resume.seventh.body": "{vehicle} · Wann immer Sie wollen: eine Minute, dann ist es fertig.",
  "system.resume.ask.first.title": "Ihr Wartungsplan steht",
  "system.resume.ask.first.title.named": "{name}, Ihr Wartungsplan steht",
  "system.resume.ask.first.body": {
    one: "{vehicle} · 1 Wartung ist fällig. Pro übernimmt ab hier.",
    other: "{vehicle} · {count} Wartungen sind fällig. Pro übernimmt jede davon.",
  },
  "system.resume.ask.first.body.zero": "{vehicle} · Jede Wartung datiert und im Blick. Pro übernimmt ab hier.",
  "system.resume.ask.second.title": "Ein Tipp, und alles läuft",
  "system.resume.ask.second.title.named": "{name}, ein Tipp, und alles läuft",
  "system.resume.ask.second.body": "{vehicle} · Ihr Plan steht und ist gespeichert. Ein Tipp, und Pro führt ihn.",
  "system.resume.ask.third.title": "Ihr Plan wartet",
  "system.resume.ask.third.title.named": "{name}, Ihr Plan wartet",
  "system.resume.ask.third.body": "{vehicle} · Nichts neu eingeben. Ein Tipp, und jede Wartung ist im Blick.",
  "system.resume.ask.fourth.title": "Mit Pro rutscht nichts durch",
  "system.resume.ask.fourth.title.named": "{name}, mit Pro rutscht nichts durch",
  "system.resume.ask.fourth.body": "{vehicle} · Ihr Plan ist gespeichert. Die meisten finden im ersten Monat etwas Vergessenes.",
  "system.resume.ask.fifth.title": "Ihr Plan ist noch gespeichert",
  "system.resume.ask.fifth.title.named": "{name}, Ihr Plan ist noch da",
  "system.resume.ask.fifth.body": "{vehicle} · Ein Tipp, und Pro übernimmt ab hier jeden Wartungstermin.",
  "system.resume.ask.sixth.title": "Der Tacho läuft weiter",
  "system.resume.ask.sixth.title.named": "{name}, der Tacho läuft weiter",
  "system.resume.ask.sixth.body": "{vehicle} · Ihr Plan hält Schritt. Ein Tipp, und Sie sind abgesichert.",
  "system.resume.ask.seventh.title": "Einen Monat später, noch bereit",
  "system.resume.ask.seventh.title.named": "{name}, noch immer bereit",
  "system.resume.ask.seventh.body": "{vehicle} · Ihr Plan ist gespeichert und wartet. Ein Tipp, und Pro übernimmt.",
  ...
  "vehicle.recalls.legend": "Rückrufe",
  "vehicle.recalls.found": {"one": "{count} Rückruf betrifft den {vehicle}", "other": "{count} Rückrufe betreffen den {vehicle}"},
  "vehicle.recalls.none": "Keine Rückrufe auf der NHTSA-Liste für den {vehicle}.",
  "vehicle.recalls.parkIt": "Nicht fahren, bis es behoben ist",
  "vehicle.recalls.risk": "Das Risiko",
  "vehicle.recalls.remedy": "Die Behebung",
  "vehicle.recalls.details": "Mehr",
  "vehicle.recalls.hide": "Ausblenden",
  "vehicle.recalls.check": "FIN auf nhtsa.gov prüfen",
  "vehicle.recalls.note": "Aus der öffentlichen Rückrufliste der NHTSA, für das Modelljahr – nicht für die FIN deines Autos. Nur Marke, Modell und Baujahr verlassen dieses Telefon.",
  ...
  "subscribed.catchup.title": "Lücken füllen.",
  "subscribed.catchup.body": "Wann wurde das jeweils zuletzt gemacht? Eine grobe Antwort reicht – aus „Kein Eintrag“ wird ein echtes Fälligkeitsdatum.",
  "subscribed.catchup.overYear": "Vor über einem Jahr",
  "subscribed.catchup.save": "Verlauf speichern",
  "subscribed.catchup.skip": "Später",
  "fuel.title": "Kraftstoff",
  "fuel.log": "Tanken erfassen",
  "fuel.seeAll": "Alle Tankfüllungen",
  "fuel.summary.last": "Letzte Füllung",
  "fuel.summary.average": "Durchschnitt",
  "fuel.summary.needFirst": "Erfasse eine Tankfüllung, dann steht sie hier.",
  "fuel.summary.needSecond": "Noch eine volle Füllung, dann kommt dein erster Wert.",
  "fuel.history.title": "Tankfüllungen",
  "fuel.history.empty": "Noch keine Tankfüllung erfasst.",
  "fuel.row.partial": "Teilfüllung",
  "fuel.deleted": "Tankfüllung gelöscht",
  "fuel.undo": "Rückgängig",
  "fuel.swipe.delete": "Löschen",
  "fuel.form.title": "Tanken erfassen",
  "fuel.form.odometer": "Tachostand ({unit})",
  "fuel.form.volume": "Menge ({unit})",
  "fuel.form.cost": "Gesamtpreis (optional)",
  "fuel.form.full": "Voll getankt",
  "fuel.form.fullHint": "Lass das an, außer du hast nicht ganz voll getankt.",
  "fuel.form.when": "Wann",
  "fuel.form.today": "Heute",
  "fuel.form.yesterday": "Gestern",
  "fuel.form.otherDate": "Anderer Tag",
  ...
  "fuel.card.unpriced": { one: "Bei {count} weiteren Füllung fehlt der Preis.", other: "Bei {count} weiteren Füllungen fehlt der Preis." },
  "fuel.card.locked.title": "Sieh, was dich Kraftstoff kostet",
  "fuel.card.locked.body": "Deine Tankfüllungen sind schon erfasst. Pro macht daraus Verbrauch, Kosten und Kosten pro Strecke.",
  "fuel.card.locked.cta": "Kraftstoff-Auswertung freischalten",
  "fuel.card.empty": "Erfasse zwei volle Tankfüllungen, dann steht hier etwas.",
  "unit.gal": "{value} gal",
  "unit.litre": "{value} L",
  "unit.gal.label": "gal",
  "unit.litre.label": "L",
  ...
  "system.csv.fuel.volume": "Kraftstoff ({unit})",
  ...
  // survey
  "survey.source.title": "Wie hast du von uns erfahren?",
  "survey.source.tiktok": "TikTok",
  "survey.source.instagram": "Instagram",
  "survey.source.youtube": "YouTube",
  "survey.source.app_store": "Suche im App Store",
  "survey.source.friend": "Freunde oder Familie",
  "survey.source.other": "Woanders",
  "survey.objection.title": "Was hat dich abgehalten?",
  "survey.objection.subtitle": "Ein Tipp. Er zeigt uns, was wir verbessern sollen.",
  "survey.objection.price": "Zu teuer",
  "survey.objection.try_first": "Ich will es erst ausprobieren",
  "survey.objection.browsing": "Ich schaue mich nur um",
  "survey.objection.no_car": "Ich habe kein Auto",
  "survey.objection.other": "Etwas anderes",
  "survey.objection.skip": "Überspringen",

  // Odometer check-in and the glovebox.
  "checkin.title": "Kilometerstand-Check",
  "checkin.notify.title": "Zeit für den Kilometerstand",
  "checkin.notify.title.named": "{name}, Zeit für den Kilometerstand",
  "checkin.notify.body": "{vehicle} · Was zeigt der Tacho? Eine Zahl hält deine Erinnerungen pünktlich.",
  "checkin.last": "Letzter Stand, {date}",
  "checkin.field": "Kilometerstand heute ({unit})",
  "checkin.why": "Kilometerabhängige Wartungen wie der Ölwechsel werden aus dieser Zahl berechnet.",
  "checkin.save": "Stand speichern",
  "checkin.same": "Unverändert",
  "checkin.lower": "Das ist weniger als der letzte Stand ({reading} {unit}). War der falsch, tippe auf den Namen des Autos, um ihn zu korrigieren.",
  "checkin.gone": "Dieses Auto ist nicht mehr in deiner Garage.",
  "checkin.update": "Stand aktualisieren",
  "documents.legend": "Handschuhfach",
  "documents.add": "Dokument hinzufügen",
  "documents.empty": "Versicherung, Fahrzeugschein und mehr – mit Erinnerung, bevor etwas abläuft.",
  "documents.kind.insurance": "Versicherung",
  "documents.kind.registration": "Fahrzeugschein",
  "documents.kind.inspection": "HU-Bericht (TÜV)",
  "documents.kind.license": "Führerschein",
  "documents.kind.warranty": "Garantie",
  "documents.kind.roadside": "Pannenhilfe",
  "documents.kind.other": "Sonstiges",
  "documents.row.expires": "Läuft ab am {date}",
  "documents.row.expired": "Abgelaufen am {date}",
  "documents.row.noExpiry": "Läuft nicht ab",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Abgelaufen",
  "documents.badge.soon": "Läuft bald ab",
  "documents.form.title": "Dokument hinzufügen",
  "documents.form.editTitle": "Dokument bearbeiten",
  "documents.form.kind": "Was ist es?",
  "documents.form.issuer": "Ausgestellt von",
  "documents.form.name": "Bezeichnung",
  "documents.form.number": "Policen- oder Ausweisnummer",
  "documents.form.expiry": "Ablaufdatum",
  "documents.form.expires": "Läuft ab",
  "documents.form.noExpiry": "Läuft nicht ab",
  "documents.form.remind": "Du wirst 30 und 7 Tage vorher erinnert.",
  "documents.form.notes": "Notizen",
  "documents.form.save": "Speichern",
  "documents.form.error": "Konnte nicht gespeichert werden. Versuch es noch einmal.",
  "documents.form.private": "Nur auf diesem Telefon gespeichert.",
  "documents.delete.button": "Dokument löschen",
  "documents.delete.title": "Dieses Dokument löschen?",
  "documents.delete.body": "Es verschwindet aus dem Handschuhfach und sendet keine Erinnerungen mehr.",
  "documents.delete.cancel": "Abbrechen",
  "documents.delete.confirm": "Löschen",
  "documents.notify.title": "{document} läuft am {date} ab",
  "documents.notify.body": "{vehicle} · Rechtzeitig verlängern.",
  "system.csv.doc.kind": "Dokument",
  "system.csv.doc.issuer": "Ausgestellt von",
  "system.csv.doc.number": "Nummer",
  "system.csv.doc.expires": "Läuft ab",
};
