...
export const it: Fragment = {
  ...
  "offer.notify.body": "Ultima volta {date}.",
  ...
  "offer.deal.perWeek": "Solo {price} a settimana",
  ...
  "onboardingA.odometer.required": "Inserisci la lettura per continuare.",
  ...
  "onboardingC.cost.oilChanges": "Cambio olio in ritardo",
  "onboardingC.cost.tracked": "Wrenchy tiene traccia degli interventi che servono alla tua auto.",
  "onboardingC.cost.source": "{overdue}. Dati statunitensi.",
  ...
  "system.resume.first.title": "Il tuo piano è quasi pronto",
  "system.resume.first.title.named": "{name}, il tuo piano è quasi pronto",
  "system.resume.first.body": "{vehicle} · Ancora un minuto e ogni scadenza è fissata.",
  "system.resume.second.title": "Riprendi da dove eri",
  "system.resume.second.title.named": "{name}, riprendi da dove eri",
  "system.resume.second.body": "{vehicle} · Tutto ciò che hai inserito è salvato. Un minuto e hai finito.",
  "system.resume.third.title": "Il tuo piano ti aspetta",
  "system.resume.third.title.named": "{name}, il tuo piano ti aspetta",
  "system.resume.third.body": "{vehicle} · Completa la configurazione e vedi cosa scade, e quando.",
  "system.resume.fourth.title": "Due minuti per un piano completo",
  "system.resume.fourth.title.named": "{name}, due minuti e il piano è tuo",
  "system.resume.fourth.body": "{vehicle} · Ogni intervallo datato e seguito. Completa oggi.",
  "system.resume.fifth.title": "Ancora salvato, ancora pronto",
  "system.resume.fifth.title.named": "{name}, ancora salvato e pronto",
  "system.resume.fifth.body": "{vehicle} · La configurazione è dove l’hai lasciata. Un minuto e hai fatto.",
  "system.resume.sixth.title": "La tua auto merita un piano",
  "system.resume.sixth.title.named": "{name}, la tua auto merita un piano",
  "system.resume.sixth.body": "{vehicle} · La maggior parte finisce in meno di due minuti. Tu sei a metà.",
  "system.resume.seventh.title": "La configurazione è ancora qui",
  "system.resume.seventh.title.named": "{name}, è ancora tutto qui",
  "system.resume.seventh.body": "{vehicle} · Quando vuoi, un minuto e hai finito.",
  "system.resume.ask.first.title": "Il tuo piano è pronto",
  "system.resume.ask.first.title.named": "{name}, il tuo piano è pronto",
  "system.resume.ask.first.body": {
    one: "{vehicle} · 1 intervento da tenere d’occhio. Da qui ci pensa Pro.",
    other: "{vehicle} · {count} interventi da tenere d’occhio. Pro li segue tutti.",
  },
  "system.resume.ask.first.body.zero": "{vehicle} · Ogni intervento datato e seguito. Da qui ci pensa Pro.",
  "system.resume.ask.second.title": "A un tocco dall’essere coperto",
  "system.resume.ask.second.title.named": "{name}, a un tocco dalla copertura",
  "system.resume.ask.second.body": "{vehicle} · Il tuo piano è pronto e salvato. Un tocco e Pro lo gestisce.",
  "system.resume.ask.third.title": "Il tuo piano ti aspetta",
  "system.resume.ask.third.title.named": "{name}, il tuo piano ti aspetta",
  "system.resume.ask.third.body": "{vehicle} · Niente da reinserire. Un tocco e ogni intervento è seguito.",
  "system.resume.ask.fourth.title": "Con Pro non sfugge nulla",
  "system.resume.ask.fourth.title.named": "{name}, con Pro non sfugge nulla",
  "system.resume.ask.fourth.body": "{vehicle} · Il tuo piano è salvato. Molti scoprono un intervento dimenticato nel primo mese.",
  "system.resume.ask.fifth.title": "Il tuo piano è ancora salvato",
  "system.resume.ask.fifth.title.named": "{name}, il piano è ancora salvato",
  "system.resume.ask.fifth.body": "{vehicle} · Un tocco e Pro riprende ogni scadenza da qui.",
  "system.resume.ask.sixth.title": "Il contachilometri sale",
  "system.resume.ask.sixth.title.named": "{name}, il contachilometri sale",
  "system.resume.ask.sixth.body": "{vehicle} · Il tuo piano è pronto a stare al passo. Un tocco e sei coperto.",
  "system.resume.ask.seventh.title": "Un mese dopo, ancora pronto",
  "system.resume.ask.seventh.title.named": "{name}, un mese dopo, ancora pronto",
  "system.resume.ask.seventh.body": "{vehicle} · Il tuo piano è salvato e ti aspetta. Un tocco e ci pensa Pro.",
  ...
  "vehicle.recalls.legend": "Richiami di sicurezza",
  "vehicle.recalls.found": {"one": "{count} richiamo riguarda la {vehicle}", "other": "{count} richiami riguardano la {vehicle}"},
  "vehicle.recalls.none": "Nessun richiamo nell’elenco NHTSA per la {vehicle}.",
  "vehicle.recalls.parkIt": "Non guidarla finché non è riparata",
  "vehicle.recalls.risk": "Il rischio",
  "vehicle.recalls.remedy": "La soluzione",
  "vehicle.recalls.details": "Dettagli",
  "vehicle.recalls.hide": "Nascondi",
  "vehicle.recalls.check": "Controlla il VIN su nhtsa.gov",
  "vehicle.recalls.note": "Dall’elenco pubblico dei richiami NHTSA, per l’anno modello, non per il VIN della tua auto. Solo marca, modello e anno lasciano questo telefono.",
  ...
  "vehicleForms.number.invalid": "Questo numero non è leggibile. Solo cifre — 84.210 o 45,5.",
  ...
  "subscribed.catchup.title": "Completa lo storico.",
  "subscribed.catchup.body": "Quando è stato fatto l’ultima volta ciascuno? Basta una stima: «Nessuno storico» diventa una scadenza vera.",
  "subscribed.catchup.overYear": "Più di un anno fa",
  "subscribed.catchup.save": "Salva lo storico",
  "subscribed.catchup.skip": "Non ora",
  "fuel.title": "Carburante",
  "fuel.log": "Registra rifornimento",
  "fuel.seeAll": "Vedi tutti i rifornimenti",
  "fuel.summary.last": "Ultimo pieno",
  "fuel.summary.average": "Media",
  "fuel.summary.needFirst": "Registra un rifornimento e comparirà qui.",
  "fuel.summary.needSecond": "Ancora un pieno e arriva il primo dato.",
  "fuel.history.title": "Rifornimenti",
  "fuel.history.empty": "Nessun rifornimento registrato.",
  "fuel.row.partial": "Rifornimento parziale",
  "fuel.deleted": "Rifornimento eliminato",
  "fuel.undo": "Annulla",
  "fuel.swipe.delete": "Elimina",
  "fuel.form.title": "Registra rifornimento",
  "fuel.form.odometer": "Contachilometri ({unit})",
  "fuel.form.volume": "Carburante ({unit})",
  "fuel.form.cost": "Totale pagato (facoltativo)",
  "fuel.form.full": "Pieno fatto",
  "fuel.form.fullHint": "Lascialo attivo, a meno che tu non abbia fatto il pieno.",
  "fuel.form.when": "Quando",
  "fuel.form.today": "Oggi",
  "fuel.form.yesterday": "Ieri",
  "fuel.form.otherDate": "Un altro giorno",
  ...
  "fuel.card.months": "Ultimi 12 mesi",
  "fuel.card.fills": { one: "Da {count} rifornimento con prezzo.", other: "Da {count} rifornimenti con prezzo." },
  "fuel.card.unpriced": { one: "Altro {count} rifornimento senza costo registrato.", other: "Altri {count} rifornimenti senza costo registrato." },
  "fuel.card.locked.title": "Scopri quanto ti costa il carburante",
  "fuel.card.locked.body": "I tuoi rifornimenti sono già registrati. Pro li trasforma in consumo, spesa e costo per distanza.",
  "fuel.card.locked.cta": "Sblocca l’analisi carburante",
  "fuel.card.empty": "Registra due pieni e qui comparirà il dato.",
  "unit.gal": "{value} gal",
  "unit.litre": "{value} L",
  "unit.gal.label": "gal",
  "unit.litre.label": "L",
  ...
  // survey
  "survey.source.title": "Come ci hai conosciuto?",
  "survey.source.tiktok": "TikTok",
  "survey.source.instagram": "Instagram",
  "survey.source.youtube": "YouTube",
  "survey.source.app_store": "Cercando sull'App Store",
  "survey.source.friend": "Un amico o un familiare",
  "survey.source.other": "Altrove",
  "survey.objection.title": "Cosa ti ha fermato?",
  "survey.objection.subtitle": "Un tocco. Ci dice cosa migliorare.",
  "survey.objection.price": "Costa troppo",
  "survey.objection.try_first": "Voglio prima provarla",
  "survey.objection.browsing": "Sto solo dando un'occhiata",
  "survey.objection.no_car": "Non ho un'auto",
  "survey.objection.other": "Altro",
  "survey.objection.skip": "Salta",
};
