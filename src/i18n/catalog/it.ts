...
export const it: Fragment = {
  ...
  "offer.paywall.preview.more": {
    one: "+{count} altro intervento, ognuno con promemoria",
    other: "+{count} altri interventi, ognuno con promemoria",
  },
  "offer.badge.pro": "Pro",
  ...
  "checkin.title": "Controllo contachilometri",
  "checkin.notify.title": "È ora di controllare il contachilometri",
  "checkin.notify.title.named": "{name}, è ora di controllare il contachilometri",
  "checkin.notify.body": "{vehicle} · Cosa segna il contachilometri? Un numero tiene puntuali i tuoi promemoria.",
  "checkin.last": "Ultima lettura, {date}",
  "checkin.field": "Contachilometri oggi ({unit})",
  "checkin.why": "Le manutenzioni a chilometraggio, come il cambio olio, si calcolano da questo numero.",
  "checkin.save": "Salva lettura",
  "checkin.same": "Non è cambiato",
  "checkin.lower": "È meno dell'ultima lettura ({reading} {unit}). Se quella era sbagliata, tocca il nome dell'auto per correggerla.",
  "checkin.gone": "Quest'auto non è più nel tuo garage.",
  "checkin.update": "Aggiorna chilometri",
  "documents.legend": "Vano portaoggetti",
  "documents.add": "Aggiungi un documento",
  "documents.empty": "Assicurazione, libretto e altro, con un promemoria prima della scadenza.",
  "documents.kind.insurance": "Assicurazione",
  "documents.kind.registration": "Libretto di circolazione",
  "documents.kind.inspection": "Revisione",
  "documents.kind.license": "Patente",
  "documents.kind.warranty": "Garanzia",
  "documents.kind.roadside": "Soccorso stradale",
  "documents.kind.other": "Altro",
  "documents.row.expires": "Scade il {date}",
  "documents.row.expired": "Scaduto il {date}",
  "documents.row.noExpiry": "Nessuna scadenza",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Scaduto",
  "documents.badge.soon": "In scadenza",
  "documents.form.title": "Aggiungi documento",
  "documents.form.editTitle": "Modifica documento",
  "documents.form.kind": "Che cos'è?",
  "documents.form.issuer": "Rilasciato da",
  "documents.form.name": "Nome",
  "documents.form.number": "Numero di polizza o documento",
  "documents.form.expiry": "Scadenza",
  "documents.form.expires": "Scade",
  "documents.form.noExpiry": "Non scade",
  "documents.form.remind": "Riceverai un promemoria 30 e 7 giorni prima.",
  "documents.form.notes": "Note",
  "documents.form.save": "Salva",
  "documents.form.error": "Impossibile salvare. Riprova.",
  "documents.form.private": "Salvato solo su questo telefono.",
  "documents.delete.button": "Elimina documento",
  "documents.delete.title": "Eliminare questo documento?",
  "documents.delete.body": "Sparirà dal vano portaoggetti e non invierà più promemoria.",
  "documents.delete.cancel": "Annulla",
  "documents.delete.confirm": "Elimina",
  "documents.notify.title": "{document} scade il {date}",
  "documents.notify.body": "{vehicle} · Rinnovalo prima che scada.",
  "system.csv.doc.kind": "Documento",
  "system.csv.doc.issuer": "Rilasciato da",
  "system.csv.doc.number": "Numero",
  "system.csv.doc.expires": "Scadenza",
};
