...
export const fr: Fragment = {
  ...
  "offer.paywall.preview.more": {
    one: "+{count} autre entretien, chacun avec un rappel",
    other: "+{count} autres entretiens, chacun avec un rappel",
  },
  "offer.badge.pro": "Pro",
  ...
  "checkin.title": "Relevé du compteur",
  "checkin.notify.title": "C'est l'heure du relevé du compteur",
  "checkin.notify.title.named": "{name}, c'est l'heure du relevé du compteur",
  "checkin.notify.body": "{vehicle} · Que dit le compteur ? Un seul chiffre garde vos rappels à l'heure.",
  "checkin.last": "Dernier relevé, {date}",
  "checkin.field": "Compteur aujourd'hui ({unit})",
  "checkin.why": "Les entretiens au kilométrage, comme la vidange, sont calculés à partir de ce chiffre.",
  "checkin.save": "Enregistrer le relevé",
  "checkin.same": "Pas de changement",
  "checkin.lower": "C'est moins que le dernier relevé ({reading} {unit}). S'il était faux, touchez le nom de la voiture pour le corriger.",
  "checkin.gone": "Cette voiture n'est plus dans votre garage.",
  "checkin.update": "Mettre à jour le compteur",
  "documents.legend": "Boîte à gants",
  "documents.add": "Ajouter un document",
  "documents.empty": "Assurance, carte grise et plus, avec un rappel avant l'échéance.",
  "documents.kind.insurance": "Assurance",
  "documents.kind.registration": "Carte grise",
  "documents.kind.inspection": "Contrôle technique",
  "documents.kind.license": "Permis de conduire",
  "documents.kind.warranty": "Garantie",
  "documents.kind.roadside": "Assistance dépannage",
  "documents.kind.other": "Autre",
  "documents.row.expires": "Expire le {date}",
  "documents.row.expired": "Expiré le {date}",
  "documents.row.noExpiry": "Sans échéance",
  "documents.row.detail": "{detail} · {when}",
  "documents.badge.expired": "Expiré",
  "documents.badge.soon": "Expire bientôt",
  "documents.form.title": "Ajouter un document",
  "documents.form.editTitle": "Modifier le document",
  "documents.form.kind": "De quoi s'agit-il ?",
  "documents.form.issuer": "Délivré par",
  "documents.form.name": "Nom",
  "documents.form.number": "N° de contrat ou de document",
  "documents.form.expiry": "Échéance",
  "documents.form.expires": "Expire",
  "documents.form.noExpiry": "N'expire pas",
  "documents.form.remind": "Vous recevrez un rappel 30 jours et 7 jours avant.",
  "documents.form.notes": "Remarques",
  "documents.form.save": "Enregistrer",
  "documents.form.error": "Enregistrement impossible. Réessayez.",
  "documents.form.private": "Enregistré uniquement sur ce téléphone.",
  "documents.delete.button": "Supprimer le document",
  "documents.delete.title": "Supprimer ce document ?",
  "documents.delete.body": "Il sera retiré de la boîte à gants et n'enverra plus de rappels.",
  "documents.delete.cancel": "Annuler",
  "documents.delete.confirm": "Supprimer",
  "documents.notify.title": "{document} expire le {date}",
  "documents.notify.body": "{vehicle} · Pensez à le renouveler à temps.",
  "system.csv.doc.kind": "Document",
  "system.csv.doc.issuer": "Délivré par",
  "system.csv.doc.number": "Numéro",
  "system.csv.doc.expires": "Expire le",
};
